...
public class Location_Activity extends CheckPermissionsActivity
	...
	private void initView(){
		...
		RadioButton rbDefault = findViewById(R.id.rb_signalDefault);
	...
	public void onCheckedChanged(RadioGroup group, int checkedId) {
		...
		if (group == rgSignal) {
			switch (checkedId) {
				case R.id.rb_signalDefault:
					locationOption.setGpsFirst(false);
					locationOption.setBeidouFirst(false);
					break;
				case R.id.rb_signalGps:
					locationOption.setGpsFirst(true);
					locationOption.setBeidouFirst(false);
					break;
				case R.id.rb_signalBeidou:
					locationOption.setGpsFirst(false);
	...
	AMapLocationListener locationListener = new AMapLocationListener() {
		...
		public void onLocationChanged(AMapLocation location) {
			if (null != location) {
				...
				sb.append("****************").append("\n");
				//定位之后的回调时间
				sb.append("回调时间: ").append(Utils.formatUTC(System.currentTimeMillis(), "yyyy-MM-dd HH:mm:ss"))
				  .append("\n");
