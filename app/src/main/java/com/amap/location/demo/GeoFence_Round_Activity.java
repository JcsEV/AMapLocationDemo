...
public class GeoFence_Round_Activity extends CheckPermissionsActivity
	...
	private final BitmapDescriptor ICON_YELLOW = BitmapDescriptorFactory
			.defaultMarker(BitmapDescriptorFactory.HUE_YELLOW);
	private final BitmapDescriptor ICON_RED = BitmapDescriptorFactory
	...
	// 记录已经添加成功的围栏
	private final HashMap<String, GeoFence> fenceMap = new HashMap<String, GeoFence>();
	...
	private void addRoundFence() {
		...
		// 要创建的围栏半径
		float fenceRadius = Float.parseFloat(radiusStr);
