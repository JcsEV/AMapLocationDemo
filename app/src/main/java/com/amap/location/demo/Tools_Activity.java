...
public class Tools_Activity extends AppCompatActivity
	...
	private void initView() {
		...
		Button btConvert = (Button) findViewById(R.id.bt_covert);
	...
	private void checkIsAvaliable(){
		...
		CoordinateConverter converter = new CoordinateConverter(
				getApplicationContext());
		//判断是否高德地图可用的坐标
		boolean result = CoordinateConverter.isAMapDataAvailable(examplePoint.getLatitude(), examplePoint.getLongitude());
		if(result){
